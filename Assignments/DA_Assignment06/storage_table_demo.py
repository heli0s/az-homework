...
resourcegroup_name = 'rg-eqvknmx-'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
storageaccount_name = 'rg-eqvknmx-'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
location = 'eastus'
...
coffee.price = 4.29
table_service.insert_entity('itemstable', coffee)
print('Created entry for Coffee...\n')
time.sleep(1)
